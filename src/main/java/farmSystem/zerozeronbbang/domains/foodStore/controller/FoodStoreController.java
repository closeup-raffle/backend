...
public class FoodStoreController {
    ...
    public ResponseDto<List<ResFindFoodStoreDto>> findFoodStores(@RequestBody ReqFindFoodStoreDto reqFindFoodStoreDto){
        return ResponseUtil.SUCCESS(ResCodeEnum.FOODSTORE_LOAD_SUCCESS.getMessage(), foodStoreService.findFoodStores(reqFindFoodStoreDto));
    }
